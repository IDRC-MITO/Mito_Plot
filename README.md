...
- `step2.py`:
  ...
  Loads the merged TSV from step1.py and generates an interactive Plotly circular plot showing heteroplasmy rates by position with mitochondrial gene regions annotated.
...
- `step3.py`:
  ...
  Loads the merged TSV from step1.py and generates an interactive 3D circular plot representing heteroplasmy rates across samples.
...
[MT_Plot_Sample_3D_Line.pdf](https://github.com/user-attachments/files/24635522/MT_Plot_Sample_3D_Line.pdf)

[MT_Plot_Sample_3D_Line_Region.pdf](https://github.com/user-attachments/files/24635525/MT_Plot_Sample_3D_Line_Region.pdf)
